...
QSGNode* BlobShape::updatePaintNode(QSGNode* oldNode, UpdatePaintNodeData*) {
    ...
    material->m_colorBottom = m_group->colorBottom();
    material->m_gradientTop = static_cast<float>(m_group->gradientTop());
    material->m_gradientBottom = static_cast<float>(m_group->gradientBottom());
